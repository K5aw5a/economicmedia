                    ...
                    <Container>
                        ...
                        <Collapse isOpen={this.state.isOpen} navbar className="menu-ul">
                            <Nav className="ml-auto" navbar >
                                ...
                                <NavItem>
                                    <NavLink onClick={() => this.scrollToTop('team')} className={(this.state.activeMenu == 'team') ? "active" : ""}>أساليب الإعلام الاقتصادي</NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink onClick={() => this.scrollToTop('about')} className={(this.state.activeMenu == 'about') ? "active" : ""}> وظائف الإعلام الاقتصادي والمقترحات</NavLink>
                                </NavItem>
                               <NavItem>
                                    <NavLink onClick={() => this.scrollToTop('blog')} className={(this.state.activeMenu == 'blog') ? "active" : ""}>آخر الأخبار</NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink onClick={() => this.scrollToTop('contact')} className={(this.state.activeMenu == 'contact') ? "active" : ""}>تواصل معنا</NavLink>
                                </NavItem>
